...
public class InventarioLuchadores {
    ...
    public void menu(){ // Menú donde se encuentran los metodos de la clase que se pueden realizar
        ...
        System.out.println("0. Mostrar lista de Luchadores");
        System.out.println("1. Mostrar Cantidad");
        System.out.println("2. Agregar Luchador");
        System.out.println("3. Eliminar Luchador");
        System.out.println("4. Buscar Luchador");
        System.out.println("5. Filtrar luchadores por Facción");
        System.out.println("6. Filtrar luchadores por Rango");
    ...
    private void agregarLuchador(){ //Si la lista no excede los 25 luchadores agrega uno nuevo
